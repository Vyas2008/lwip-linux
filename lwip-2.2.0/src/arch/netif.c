...
//extern int w_pcap_findalldevs(pcap_if_t **interfaces, char *errbuf);
extern int w_pcap_findalldevs(char *errbuf);
...
/*
    if(w_pcap_findalldevs(&errbuf)==-1)
    {
